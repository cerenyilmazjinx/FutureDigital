// src/lib.rs
/*
 * Core library for FutureDigital
 */
...
#[derive(Debug)]
pub struct FutureDigitalProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FutureDigitalProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FutureDigital processing");
    
    let mut processor = FutureDigitalProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FutureDigitalProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FutureDigitalProcessor::new(false);
